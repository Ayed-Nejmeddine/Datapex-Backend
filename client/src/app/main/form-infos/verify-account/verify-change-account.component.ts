...
@Component({
  selector: 'app-verify-change-account',
  templateUrl: 'verify-change-account.component.html',
  styleUrls: ['verify-change-account.component.scss']
})
export class VerifyChangeAccountComponent implements OnInit, AfterViewInit {
